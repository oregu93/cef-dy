...
**Следующий шаг.** `T-02R-05`: Спецификация W02-02R-C-001 заморожена и одобрена методологически. Следующее действие — отдельное решение Project Control об авторизации исполнения C-001. C-001 не выполнялся; C-002 не авторизован; детекторные данные всех 18 сканов отложенной выборки (`holdout`) недоступны.
...
заморожена; открытых вопросов проектирования нет. C-001 не выполнялся.
Следующее управленческое действие — отдельное решение Project Control об
авторизации исполнения C-001. Исполнение C-002 и детекторный доступ ко всем
18 сканам отложенной выборки остаются неавторизованными.
