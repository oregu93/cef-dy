...
**Текущий научный вопрос.** Сможет ли будущая отдельно подготовленная реализация замороженной спецификации C-001 v1.1 сформировать на данных для поиска и метаданных отложенной выборки без детекторных полей самодостаточную модель и реестр гипотез для будущего C-002, сохранив каталог B-001 и границы слепого анализа?
...
**Следующий научный шаг.** `W02-02R-C-001-v1.1-implementation-preparation`: Отдельно подготовить реализацию и конфигурацию для замороженной спецификации C-001 v1.1, затем провести conformance review и отдельное execution-authorization review. Исполнение C-001/A2, C-002 и детекторный доступ к отложенной выборке не авторизованы.
